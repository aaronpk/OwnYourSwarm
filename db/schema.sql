CREATE TABLE `users` (
  ...
  `backfeed_poll_interval` int(11) NOT NULL DEFAULT '0',
  `date_next_backfeed_poll` datetime DEFAULT NULL,
  ...
  `mark_all_private` tinyint(4) DEFAULT '0',
  `add_tags` varchar(255) DEFAULT '',
  `include_private_checkins` tinyint(4) DEFAULT '1',
  `send_responses_swarm` tinyint(4) DEFAULT '0',
  `send_responses_other_users` tinyint(4) DEFAULT '0',
